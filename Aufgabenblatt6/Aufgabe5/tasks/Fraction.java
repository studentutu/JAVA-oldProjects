...
public class Fraction {
    ...
    public static int[] addFractions(int num1, int denom1, int num2, int denom2) {
        return ( denom1==denom2?new int[]{num1+num2,denom1} :addFractions(denom2*num1,denom1*denom2,denom1*num2,denom1*denom2)  /* TODO: modify expression */);
    }
	...
	System.out.println(fr2.addFrac(fr));
    }
