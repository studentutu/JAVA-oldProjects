...
public class Aufgabe3Test {
    ...
    public void testAccToNothing() {
        long [] accumulate = new long[3];
        Arrays.plus(accumulate, new long[]{1,2,3});
        assertArrayEquals(new long[]{1,2,3}, accumulate);
    }

    public void testAccToSame() {
        long [] accumulate = new long[]{1,2,3};
        Arrays.plus(accumulate, new long[]{1,2,3});
        assertArrayEquals(new long[]{2,4,6}, accumulate);
    }


    public void testAccUnchanged() {
        long [] accumulate = new long[]{1,2};
        Arrays.plus(accumulate, new long[]{1,2,3});
        assertArrayEquals(new long[]{1,2}, accumulate);
    }


    public void testAccNull() {
        long [] accumulate = new long[]{1,2};
        Arrays.plus(accumulate, null);
        assertArrayEquals(new long[]{1,2}, accumulate);
    }
    ...
    public void testPascalSimple() {
        ...
        assertArrayEquals(new long[][]{
                ...
                new long[]{1,2,1},
                new long[]{1,3,3,1},
                new long[]{1,4,6,4,1}}, Arrays.pascal(4));
    }

    public void checkPrint(String expected, long[][] array) {
    ...
    public void testPrint() {
        ...
        checkPrint("1,2\n2\n", new long[][]{new long[]{1,2}, new long[]{2}});
        checkPrint("1,2\n2\n4,5,6\n", new long[][]{new long[]{1,2}, new long[]{2}, new long[]{4,5,6}});

        checkPrint("1,2\n2\n4,5,6\n", new long[][]{new long[]{1,2}, new long[]{2}, null, new long[]{4,5,6}});
        checkPrint("1,2\n2\n4,5,6\n", new long[][]{null, new long[]{1,2}, new long[]{2}, new long[]{4,5,6}});
        checkPrint("1,2\n2\n4,5,6\n", new long[][]{new long[]{1,2}, new long[]{2}, new long[]{4,5,6}, null});
    }
    @Test
