...
public class Aufgabe3 {
    ...
    // einfach einen zusätzlichen Parameter hinzufügen
    private static void rec(int i, char a, char b, char c, int counter) {
        if (i > 0) {
            System.out.println("Aufrufebene " + counter + " i = " + i + " a = " + a + ", b = " + b + ", c = " + c);
            rec(i - 1, a, c, b, counter+1);
            System.out.println("Von " + a + " nach " + c);
            rec(i-1, b, a, c, counter+1);
        }
    }
